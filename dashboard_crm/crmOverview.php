...
$dataFinal = filter_input(INPUT_GET, 'dataFinal');
               ...
               $read = $conn->prepare("SELECT count(RESPOSTA) AS RESPOSTA, count(STATUS) AS STATUSCOUNT, sum(VALOR_CONVERSAO) AS VALORCONVERSAO,
                  sum(VALOR_CONVERSAO)/COUNT(STATUS) AS TM
                  FROM TB_CAM_CLIENTE
