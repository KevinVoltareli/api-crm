...
if($filial !== 'todas'){
$sql = ("SELECT DISTINCT p.STATUS AS STATUS,g.PESNOME AS CLIENTE,sum(a.LCTVALOR) AS TOTALVAL,m.TELDDD AS DDD,m.TELNUMERO AS CELULAR, g.PESDTCADASTRO AS DTCAD, f.CLIULTIMAATUALIZACAO AS DTULTCOMP, o.PESNOME AS FILIAL, f.CLIID AS IDCLIENTE
