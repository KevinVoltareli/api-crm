...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
  ...
  try {
    ...
    if($tag === 'nao'){
    $sql = "UPDATE TB_CAM_CLIENTE SET RESPOSTA = NULL WHERE ID_CLIENTE = :id";
  } else{
    $sql = "UPDATE TB_CAM_CLIENTE SET RESPOSTA = :tag, USER_EMAIL = :email, CREATED_AT = CURRENT_DATE  WHERE ID_CLIENTE = :id";
  }
